...
export default class PoolView extends React.Component<PoolViewProps, {}> {
    ...
    private handleStakeAmount(e: any) {
        ...
        this.stakeAmountStr = isNaN(parsed) ? '' : parsed.toString();
    ...
    public render(): ReactNode {
        ...
        return (
            <tr>
                ...
                <td>
                    <input type="text" placeholder="amount" value={this.stakeAmountStr} onChange={this.handleStakeAmount}/>
                    <button disabled={this.processing} onClick={this.handleStakeButton}>Stake</button></td>
            </tr>
        );
    }
}
